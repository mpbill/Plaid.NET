...
namespace Bham.Plaid
{
    ...
    public class PlaidClient
    {
        ...
        public Task<Institution.SearchResponse> FetchInstitutionsAsync(Institution.GetRequest request)
        {
        ...
        public Task<Institution.SearchResponse> FetchAllInstitutionsAsync(Institution.GetRequest request)
        {
            return PostAsync<Institution.SearchResponse>("institutions/get", request);
        }
